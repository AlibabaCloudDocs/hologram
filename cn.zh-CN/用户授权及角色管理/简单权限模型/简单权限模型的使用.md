...
4.  创建用户。
    ...
    **说明：**
    ...
    -   如果是子账号，执行`spm_create_user`时需要在UID账号前加p4\_，即“p4\_uid”。
...
**说明：** 您也可以通过[Hologres管控台](https://hologram.console.aliyun.com/#/instance)，使用可视化的方式将用户从某个用户组移除，详情请参见[t1877469.md\#](/cn.zh-CN/实例管理/Hologres管理控制台/DB管理.md)。
