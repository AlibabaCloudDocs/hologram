...
|时间|特性|类别|描述|产品文档|
|--|--|--|--|----|
|2021.05.17|新增产品形态|新增功能|Hologres V0.10版本新增内容发布。|[Hologres V0.10版本（2021年5月）](/cn.zh-CN/新功能发布记录/产品版本发布动态.md)|
...
|2020.07.17|新增HoloWeb功能模块|新增功能|为您介绍HoloWeb支持的数据连接、数据库、模式、表、外部表、文件夹及SQL窗口模块的功能。|-   [新增实例](/cn.zh-CN/连接开发工具/HoloWeb/连接管理/数据连接.md)
