...
|2021.01.07|新增最佳实践|体验优化|为您介绍将原MaxCompute Lightning服务迁移至Hologres共享集群（MaxCompute BI加速版）的相关操作流程。|[迁移Lightning至共享集群概述](/cn.zh-CN/共享集群（MaxCompute BI加速版）/迁移Lighting至共享集群（MaxCompute BI加速版）/迁移Lightning至共享集群概述.md)|
...
|2020.10.26|新增扩展函数|新增功能|为您介绍在Hologres中如何使用向量计算功能。|[向量Proxima（Beta）](/cn.zh-CN/Hologres SQL/扩展函数/向量Proxima（Beta）.md)|
...
-   [一键上传本地文件](/cn.zh-CN/连接开发工具/HoloWeb/工具/数据同步/一键上传本地文件.md)
-   [查看活跃Query](/cn.zh-CN/连接开发工具/HoloWeb/工具/查看活跃Query.md) |
...
|2020.07.23|新增子账号使用Hologres的功能模块|新增功能|为您介绍主账号如何创建子账号，并授权子账号使用Hologres。|-   [授予RAM用户权限](/cn.zh-CN/账号与权限管理/授权操作/授予RAM用户权限.md)
...
|2020.06.07|新增使用教程|体验优化|为您介绍新用户如何开通实例、创建工作空间和开发数据。|[新用户基于DataWorks使用HoloStudio]()|
|2020.06.07|新增使用教程|体验优化|为您介绍如何开通Hologres实例、连接Hologres实例至HoloWeb并使用HoloWeb开发数据。|[基于Hologres实例使用HoloWeb]()|
|2020.06.07|新增使用教程|体验优化|为您介绍已经开通DataWorks工作空间的用户如何使用HoloStudio查询MaxCompute外部表数据。|[使用HoloStudio查询MaxCompute外部表数据]()|
...
-   [Hologres Reader]()
-   [使用数据集成导入MaxCompute的数据至Hologres](/cn.zh-CN/数据接入/大数据/MaxCompute/使用数据集成导入MaxCompute的数据至Hologres.md)
-   [离线同步RDS MySQL数据至Hologres](/cn.zh-CN/数据接入/数据库/离线同步RDS MySQL数据至Hologres.md) |
...
|时间|特性|类别|描述|产品文档|
|--|--|--|--|----|
|2020.03.30|新增数据接入方式|新增功能|为您介绍如何通过调用实时数据API实时写入数据至Hologres分区表的父表。|[Hologres结果表](/cn.zh-CN/数据接入/大数据/实时计算Flink版/Blink独享集群（原产品线）/Hologres结果表.md)|
...
-   [概览](/cn.zh-CN/了解控制台/Hologres管理控制台/概览.md) |
|2020.03.20|新增授权模型|新增说明|为您介绍简单权限模型的相关内容。|[简单权限模型概述](/cn.zh-CN/账号与权限管理/Hologres权限模型/简单权限模型/简单权限模型概述.md)|
|2020.03.20|新增API接口|新增说明|Hologres的实时数据API支持实时写入多种数据源。|[实时数据API](/cn.zh-CN/数据接入/大数据/实时计算Flink版/Blink独享集群（原产品线）/实时数据API.md)|
