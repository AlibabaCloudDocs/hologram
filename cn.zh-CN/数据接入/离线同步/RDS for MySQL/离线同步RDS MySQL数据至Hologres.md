...
|是|
        |写入模式|        -   **SDK（极速写入）**：通过Hologres的实时数据API写入数据，详情请参见[实时数据API](/cn.zh-CN/数据接入/实时写入/实时计算Flink版/Blink独享/实时数据API.md)。
...
|是|
    ...
    2.  在**字段映射**区域，您可以选择同步部分或全部字段，示例如下。
        ...
        ![770](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/4560129951/p96819.png)
