...
![Example](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/8855013061/p162831.png)
...
![Location](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p162838.png)
...
-   Query system table hologres.hg\_stats and display its information, such as the histogram of each column, average width, and number of fields with different values, as shown in the following figure.
    ...
    ![Other information](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p162996.png)
...
![Updated statistics information](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p163774.png)
...
-   Select a join condition column during a JOIN operation as the distribution key.
    ...
    ![motion](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p163980.png)
    ...
    ![Set the distribution key](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p163985.png)
...
-   Optimize single-stage aggregation to multi-stage aggregation.
    ...
    -   Three-stage aggregation: Aggregate data by file, aggregate data in each shard, and then summarize the aggregation results of all shards.
        ...
        ![Three-stage aggregation](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p164212.png)

    -   Two-stage aggregation: Aggregate data in each shard, and then summarize the aggregation results of all shards.

        ![Two-stage aggregation](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p164213.png)
...
-   Avoid federated queries.
    ...
    ![post](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/9855013061/p164218.png)
    ...
    ![SQL statement after optimization](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/en-US/0955013061/p164219.png)
