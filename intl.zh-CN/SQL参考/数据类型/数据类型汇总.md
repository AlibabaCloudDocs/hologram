...
|SERIAL|自增序列|Hologres 0.8版本|详情请参见 [自增序列Serial]()|无|无|无|
...
|DECIMAL|NUMERIC|Hologres 0.8及之前版本|MaxCompute的DECIMAL如果未指定精度，则默认为（38，18），使用[IMPORT FOREIGN SCHEMA](/intl.zh-CN/SQL参考/DDL/SCHEMA/IMPORT FOREIGN SCHEMA.md)创建表时系统会自动转换精度。|
